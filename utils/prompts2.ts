...
export const descriptor = {
  ...
  "Rendering: Properties": ["transparent", "textured", "rough", "matte"],
  Time: [
    "1930s style",
    "1950s style",
    "1960s style",
...
export const color = {
  Grayscale: ["white", "black", "light gray", "dark gray"],
  Colors: [
    "maroon",
    "red",
    "orange",
...
export const artists = {
  ...
  "Constructivism (1915-1940, Soviet Union, Germany, art for social purposes)":
    ["Alexander Rodchenko", "El Lissitzky", "Liubov Popova"],
  ...
  "Suprematism (1910-1920, Russia, simple geometric forms, color, very minimal)":
    ["El Lissitzky", "Kazimir Malevich", "Mikhail Menkov"],
